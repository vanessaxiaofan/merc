...
# Authors: Xiaofan Liu and Xin Zhou
...
# by model covariates. Logistic model are implemented. A reliability study is required to
# empirically charaterize the measurement error model. Details are given in Rosner et al.(1989), Rosner et al.(1990), and 
# Rosner et al.(1992) including "real data" examples

# Reference:
# Rosner B, Spiegelman D, Willett WC. Correction of logistic regression relative risk estimates and confidence intervals for measurement error:
# the case of multiple covariates measured with error. Am J Epidemiol. 1990 Oct;132(4):734-45. doi: 10.1093/oxfordjournals.aje.a115715. PMID: 2403114.
